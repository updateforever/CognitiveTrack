# L40 旧 Stage-1 训练服务器复现（归档）

> **历史配方提示（2026-08-13）：** 本文保留用于复现已经完成的旧 Stage-1 二字段、
> reference 坐标文本实验。不要直接用本文的旧 Stage-1 命令启动新实验。当前 VLT-v6
> 固定三图与 core SFT 流程见 [当前 VLT-v6 core SFT](../vlt_v6_core_sft.md)，visual-v5
> 历史流程见 [`visual_v5_iteration.md`](visual_v5_iteration.md)，实际状态与完整设计分别见
> [`project_status_20260813.md`](project_status_20260813.md)、
