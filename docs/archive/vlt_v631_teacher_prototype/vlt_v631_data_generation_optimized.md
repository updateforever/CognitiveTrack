# VLT-v6.3.1 数据生成方案（调研优化归档版）

> **归档说明（2026-08-15）：** 本文是正式数据生成前的研究草案，样本规模和入口已经
> 被正式 release 取代。
...
- VLM Tracking 数据生成调研报告（历史临时路径：`/tmp/vlm_tracking_data_generation_research.md`）
- [VLT-v6.3.1 数据生成文档](vlt_v631_data_generation.md)
- [当前实施进度追踪](../../implementation_progress.md)
