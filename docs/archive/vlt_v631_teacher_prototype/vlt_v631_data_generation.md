# VLT-v6.3.1 Core SFT 数据生成框架（归档原型）

> **归档说明（2026-08-15）：** 本文描述依赖 Qwen2.5-VL-32B API 的旧原型，不是正式
> deterministic Core pipeline。当前说明见 [`../../vlt_v6_core_sft.md`](../../vlt_v6_core_sft.md)。
